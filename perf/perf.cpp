...
struct poly_for_each_base_collection:base_collection<Base>
{
  ...
  void for_each(F f)
  {
    boost::poly_collection::for_each<T...>(*this,f);
  }
};
...
>
double erase_perf(
  unsigned int n,element_sequence<Element...> elements,label<Container> lab)
{
  return measure(n/2,std::bind(erase_perf_functor{},n,elements,lab));
}
...
int main()
{
  ...
  //unsigned int n0=1000,n1=11000000,dn=100000;

  {
    ...
    auto rfbc= label<poly_for_each_base_collection<base,derived1,derived2,derived2>>
               {"base_collection (restituted poly::for_each)"};

    insert_perf(n0,n1,dn,seq,pv,bc);
    for_each_perf(n0,n1,dn,seq,f,pv,spv,shpv,bc,fbc,rfbc);
    //erase_perf(n0,n1,dn,seq,pv,bc);
  }
  {
    ...
    insert_perf(n0,n1,dn,seq,fv,fc);
    for_each_perf(n0,n1,dn,seq,f,fv,sfv,shfv,fc,ffc,rffc);
    //erase_perf(n0,n1,dn,seq,av,ac,ac2);
  }
  {
    ...
    insert_perf(n0,n1,dn,seq,av,ac);
    for_each_perf(n0,n1,dn,seq,f,av,sav,shav,ac,fac,rfac);
    //erase_perf(n0,n1,dn,c,av,ac,ac2);
  }
}
